     ...
     (:prefix-map ("b" . "buffers")
      ...
      (:prefix-map ("o" . "org")
        ...
        (:prefix ("c" . "clock")
          ...
          :desc "Go To Active Clock"           "g" #'org-clock-goto)
        ...
        :desc "Refile"                         "m" #'org-refile
        :desc "Capture"                        "o" #'org-capture
        :desc "Goto capture"                   "O" #'org-capture-goto-target
        :desc "Todo list"                      "t" #'org-todo-list
        :desc "Tags search"                    "T" #'org-tags-view
      ...
      (:prefix-map ("w" . "workspaces/windows")
        ...
        :desc "Split Horizontally"           "s" #'split-window-below
        :desc "Split Vertically"             "v" #'split-window-right
        :desc "Undo window config"           "u" #'winner-undo
        :desc "Redo window config"           "r" #'winner-redo
        :desc "Move Down"                    "j" #'windmove-down
        :desc "Move Up"                      "k" #'windmove-up
        :desc "Move Left"                    "h" #'windmove-left
        :desc "Move Right"                   "l" #'windmove-right
        :desc "Close"                        "c" #'delete-window)

      ;;; TODO make a wrapper function for workspace/new that immediately renames
      (:prefix-map ("a" . "tabs")
        ...
        :desc "Switch to"                    "a" #'+workspace/switch-to
